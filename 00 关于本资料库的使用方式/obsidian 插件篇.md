...
会有这个侧边栏，点击后会对整个界面进行翻译，包括插件以及设置界面，我觉得这应该是因为 obsidian 是使用浏览器框架制作的应用，这个插件保持的还是浏览器插件的逻辑
...
![](附件/Pasted%20image%2020250218152702.png)
...
![|700](附件/Pasted%20image%2020250122085823.png)


#### 版本历史对比 Version History Diff（选装）

默认设置即可，无需修改
![|725](附件/Pasted%20image%2020250228174634.png)
![|700](附件/Pasted%20image%2020250228175002.png)
